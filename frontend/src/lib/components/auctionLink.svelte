...
>
	...
	<!-- Image -->
	<img src={auction.imageUrl == "/images/" ? logo : PUBLIC_SERVER_URL.replace("wss", "https").replace("ws", "http")+ auction.imageUrl} alt="Market image" class="h-60 w-60 rounded object-cover" />
</div>
