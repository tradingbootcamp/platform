...
# sources: portfolio.proto, redeemable.proto, market.proto, market-type.proto, market-group.proto, market-settled.proto, orders-cancelled.proto, side.proto, order.proto, trade.proto, order-created.proto, transfer.proto, request-failed.proto, out.proto, account.proto, redeem.proto, orders.proto, trades.proto, auction.proto, auction-settled.proto, market-positions.proto, universe.proto, server-message.proto, make-transfer.proto, create-market.proto, create-universe.proto, create-market-type.proto, delete-market-type.proto, create-market-group.proto, create-auction.proto, settle-market.proto, edit-market.proto, settle-auction.proto, edit-auction.proto, create-order.proto, buy-auction.proto, client-message.proto
...
class Out(betterproto.Message):
    market_id: int = betterproto.int64_field(1, group="_market_id")
...
@dataclass
class GetMarketPositions(betterproto.Message):
    market_id: int = betterproto.int64_field(1)


@dataclass
class MarketPositions(betterproto.Message):
    market_id: int = betterproto.int64_field(1)
    positions: List["ParticipantPosition"] = betterproto.message_field(2)


@dataclass
class ParticipantPosition(betterproto.Message):
    account_id: int = betterproto.int64_field(1)
    gross: float = betterproto.double_field(2)
    net: float = betterproto.double_field(3)
    avg_buy_price: float = betterproto.double_field(4, group="_avg_buy_price")
    avg_sell_price: float = betterproto.double_field(5, group="_avg_sell_price")
...
class ServerMessage(betterproto.Message):
    ...
    market_positions: "MarketPositions" = betterproto.message_field(31, group="message")
...
class EditAuction(betterproto.Message):
    ...
    name: str = betterproto.string_field(2, group="_name")
    description: str = betterproto.string_field(3, group="_description")
    image_filename: str = betterproto.string_field(4, group="_image_filename")
    bin_price: float = betterproto.double_field(5, group="_bin_price")
...
class ClientMessage(betterproto.Message):
    ...
    get_market_positions: "GetMarketPositions" = betterproto.message_field(
        24, group="message"
    )
